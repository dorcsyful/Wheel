    ...
    namespace EventSystem
    {
        ...
        public:
            ...
            void OnCollision(uint32_t a, uint32_t b,
                 std::function<void(const Collision::Collision2DManifold&)> cb) {
        ...
        private:
            ...
            std::unordered_map<uint64_t, std::vector<std::function<void(const Collision::Collision2DManifold&)>>> m_EnterHandlers;
