...
namespace Wheel
{
    namespace Events
    {
        ...
        {
            CollisionEnterEvent(const Collision::Collision2DManifold& a_Manifold) : manifold(a_Manifold) {}
            const Collision::Collision2DManifold manifold;
        };
        ...
        {
            CollisionResultsFinished(const std::vector<Collision::Collision2DManifold>* a_ManifoldPtr) : ManifoldPtr(a_ManifoldPtr) {}
            const std::vector<Collision::Collision2DManifold>* ManifoldPtr = nullptr;
        };
