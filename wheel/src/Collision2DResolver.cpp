#include "systems/subsystems/Collision2DResolver.h"
...
void Wheel::Engine::Subsystems::Collision2DResolver::IntegratePseudoPosition(Components::Transform2D& a_Transform2D,
...
void Wheel::Engine::Subsystems::Collision2DResolver::SolveConstraints(std::vector<Collision::Collision2DManifold>* a_Manifolds, Engine::Scene* a_Scene, float a_DeltaTime)
{
