...
const Wheel::Math::Vector2* Wheel::Collision::BoxBoxCollision2D::GetVertices(
    const BoxCollider2D& a_Collider, const Common::Transform2D& a_Transform2D)
{
...
int Wheel::Collision::BoxBoxCollision2D::GetContactPoints(const BoxCollider2D& a_Collider1,
    const BoxCollider2D& a_Collider2, int a_Normal1, int a_Normal2, Math::Vector2* a_ContactPoints, uint16_t* a_ContactIds, bool a_Flip)
{
...
void Wheel::Collision::BoxBoxCollision2D::ClipSegmentToLine(const Math::Vector2& a_P1,
...
void Wheel::Collision::BoxBoxCollision2D::ProjectOntoAxis(const Math::Vector2* a_Vertices,
