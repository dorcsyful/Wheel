...
Wheel::Physics::JointTempCalculations Wheel::Physics::JointConstraintSolver::
PrepareJointConstraintSolver(Common::Transform2D& a_Transform1, Common::Transform2D& a_Transform2,
    Rigidbody2D& a_Rigidbody1, Rigidbody2D& a_Rigidbody2, DistanceJoint2D& a_Joint, float a_DeltaTime)
{
...
void Wheel::Physics::JointConstraintSolver::SolveDistanceJointConstraint(JointTempCalculations& jointCalc)
{
...
void Wheel::Physics::JointConstraintSolver::WarmStart(JointTempCalculations& jointCalc, float cachedImpulse)
{
    if (!jointCalc.go)
        return;
