    ...
    namespace Physics
    {
        ...
        struct CollisionTempCalculations
        {
            CollisionTempCalculations(Collision::Collision2DManifold& a_Manifold, float a_DeltaTime,
                Common::Transform2D& a_ATransform, Common::Transform2D& a_BTransform,
                Rigidbody2D& a_A, Rigidbody2D& a_B)
            ...
            Common::Transform2D& a_Transform;
            Common::Transform2D& b_Transform;
