...
void Wheel::Physics::CollisionConstraintSolver::WarmStart(CollisionTempCalculations& tempCalc, const float* a_NormalImpulse, const float* a_FrictionImpulse)
{
...
void Wheel::Physics::CollisionConstraintSolver::SolveFrictionConstraint(CollisionTempCalculations& a_TempCalc, int i)
{
...
Wheel::Physics::CollisionTempCalculations Wheel::Physics::CollisionConstraintSolver::PrepareConstraintSolver(Collision::Collision2DManifold& a_Manifold,
                                                                                                           Common::Transform2D& a_ATransform, Common::Transform2D& a_BTransform,Rigidbody2D& a_A, Rigidbody2D& a_B,float a_DeltaTime)
{
    CollisionTempCalculations tempCalc(a_Manifold, a_DeltaTime, a_ATransform, a_BTransform, a_A, a_B);
...
void Wheel::Physics::CollisionConstraintSolver::SolvePseudoVelocities(CollisionTempCalculations& tempCalc)
{
    //(vA + ωA × rA - vB - ωB × rB)
...
void Wheel::Physics::CollisionConstraintSolver::Solve2ContactConstraint(CollisionTempCalculations& tempCalc)
{
    Math::Vector2 normal = tempCalc.Manifold.collisionNormal;
...
void Wheel::Physics::CollisionConstraintSolver::Solve1ContactConstraint(CollisionTempCalculations& tempCalc)
{
    Math::Vector2 normal = tempCalc.Manifold.collisionNormal;
